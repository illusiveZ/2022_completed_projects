...
if(trim($name) == "") {
    ...
    echo '<div clas="error_message">You have entered an invalid e-mail address. Please try again</div>';
    exit();
}

if(trim($comments) == '') {
    echo '<div class="error_message">Please enter a message</div>';
    exit();
}
...
if(mail($address, $e_subject, $msg, $headers)) {
    // If email has been successfully sent
