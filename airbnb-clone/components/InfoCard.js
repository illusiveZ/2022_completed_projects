...
function InfoCard({ img, location, title, description, star, price, total }) {
  return (
    <div className="flex flex-col shadow-md justify-center md:shadow-none mb-4 md:mb-0 last:mb-6 border-2 rounded-lg md:border-0 md:rounded-none sm:flex-row py-6 px-2 border-b cursor-pointer pr-4 hover:opacity-80 hover:shadow-lg transition duration-200 ease-out first:border-t">
