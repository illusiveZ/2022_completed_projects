  ...
  return (
    ...
    >
      <div className="pb-6 border-b">
        ...
        <div
          className="text-bold text-xl text-gray-500 px-4 py-3 mt-2 cursor-pointer border-2 border-red-400 rounded-full dark:text-dark-text"
          tabIndex="-1"
          id="user-menu-item-1"
        >
          Profile
        ...
        <div
          className="text-bold text-xl text-gray-500 px-4 py-3 mt-6 cursor-pointer border-2 border-red-400 rounded-full dark:text-dark-text"
          tabIndex="-1"
          id="user-menu-item-3"
          href="#"
        >
