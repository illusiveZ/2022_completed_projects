...
var useStyles = createMemoStyles.createMemoStyles({
  ...
  label: ({
    ...
    transitionTimingFunction,
    size
  }) => __spreadProps(__spreadValues(__spreadValues({}, getFocusStyles.getFocusStyles(theme)), getFontStyles.getFontStyles(theme)), {
  ...
  active: ({
    ...
    backgroundColor: color in theme.colors ? getThemeColor.getThemeColor({ theme, color, shade: 6 }) : theme.colorScheme === "dark" ? theme.colors.dark[5] : theme.white
  })
});
