...
function ChevronIcon(_a) {
  var _b = _a, { size, error, style, themeOverride } = _b, others = __objRest(_b, ["size", "error", "style", "themeOverride"]);
  const _size = getSizeValue.getSizeValue({ size, sizes: iconSizes });
