...
var scrollIntoView = require('../../utils/scroll-into-view/scroll-into-view.js');
...
function Select(_a) {
    ...
    switch (event.nativeEvent.code) {
      case "ArrowUp": {
        ...
        setHovered((current) => {
          ...
          scrollIntoView.scrollIntoView(dropdownRef.current, itemsRefs.current[(_a2 = filteredData[nextIndex]) == null ? void 0 : _a2.value]);
          return nextIndex;
        });
        break;
      }
  ...
  return /* @__PURE__ */ React__default.createElement(InputWrapper.InputWrapper, __spreadValues({
    ...
    tabIndex: -1
  }, /* @__PURE__ */ React__default.createElement(Input.Input, __spreadValues(__spreadProps(__spreadValues({}, others), {
    type: "text",
    required,
