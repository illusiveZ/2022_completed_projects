...
function getPositionStyles({
  ...
  switch (position) {
    case "top":
      return { top: 0, left: 0, right: 0, height: getSizeValue.getSizeValue({ size, sizes }) };
    case "bottom":
      return { bottom: 0, left: 0, right: 0, height: getSizeValue.getSizeValue({ size, sizes }) };
    case "right":
      return { bottom: 0, top: 0, right: 0, width: getSizeValue.getSizeValue({ size, sizes }) };
    case "left":
      return { bottom: 0, top: 0, left: 0, width: getSizeValue.getSizeValue({ size, sizes }) };
    default:
      return null;
  }
}
