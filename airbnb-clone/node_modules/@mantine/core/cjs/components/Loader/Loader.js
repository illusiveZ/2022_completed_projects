...
function Loader(_a) {
  var _b = _a, { size = "md", color, themeOverride, className } = _b, others = __objRest(_b, ["size", "color", "themeOverride", "className"]);
  const theme = useMantineTheme.useMantineTheme(themeOverride);
  return /* @__PURE__ */ React__default.createElement("svg", __spreadValues({
    width: `${getSizeValue.getSizeValue({ size, sizes: LOADER_SIZES })}px`,
    fill: getThemeColor.getThemeColor({ theme, color, shade: theme.colorScheme === "dark" ? 4 : 6 }),
    viewBox: "0 0 135 140",
    xmlns: "http://www.w3.org/2000/svg",
    role: "presentation",
    className: cx__default("mantine-loader", className)
