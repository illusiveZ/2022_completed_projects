...
function Accordion(_a) {
  ...
  const items = React__default.Children.toArray(children).filter((item) => item.type === AccordionItem.AccordionItem);
  ...
  const controls = items.map((item, index) => /* @__PURE__ */ React__default.createElement(AccordionControl.AccordionControl, __spreadProps(__spreadValues({}, item.props), {
    key: index,
    themeOverride,
    transitionDuration,
    opened: value[index],
  ...
  return /* @__PURE__ */ React__default.createElement("div", __spreadValues({}, others), controls);
}
