...
var useStyles = createMemoStyles.createMemoStyles({
  ...
  thumb: ({ theme, color, size }) => __spreadProps(__spreadValues({}, getFocusStyles.getFocusStyles(theme)), {
    boxSizing: "border-box",
    position: "absolute",
    height: getSizeValue.getSizeValue({ sizes: SliderRoot_styles.sizes, size }) * 2,
    width: getSizeValue.getSizeValue({ sizes: SliderRoot_styles.sizes, size }) * 2,
    backgroundColor: theme.colorScheme === "dark" ? getThemeColor.getThemeColor({ theme, color, shade: 6 }) : theme.white,
    border: `4px solid ${theme.colorScheme === "dark" ? theme.white : getThemeColor.getThemeColor({ theme, color, shade: 6 })}`,
