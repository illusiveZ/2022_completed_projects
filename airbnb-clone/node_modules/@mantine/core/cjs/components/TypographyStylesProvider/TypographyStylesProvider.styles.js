...
var useStyles = createMemoStyles.createMemoStyles({
  root: ({ theme }) => {
    ...
    return __spreadProps(__spreadValues(__spreadProps(__spreadValues({}, getFontStyles.getFontStyles(theme)), {
      ...
      "& a": __spreadProps(__spreadValues({}, getFocusStyles.getFocusStyles(theme)), {
      ...
      "& blockquote": {
        ...
        color: theme.colorScheme === "dark" ? theme.colors.dark[0] : theme.black,
        borderLeft: `3px solid ${getThemeColor.getThemeColor({
          theme,
