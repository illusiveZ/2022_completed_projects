...
function Radio(_a) {
  ...
  const classes = Radio_styles['default']({ color, size, theme }, classNames, "radio-group");
  const _styles = mergeStyles.mergeStyles(classes, styles);
  const uuid = hooks.useId(id);
  return /* @__PURE__ */ React__default.createElement("div", {
    className: cx__default(classes.radioWrapper, className),
    style: __spreadValues(__spreadValues({}, style), _styles.radioWrapper),
    title
