...
function Tooltip(_a) {
  ...
  const classes = Tooltip_styles['default']({ theme, color }, classNames, "tooltip");
  ...
  return /* @__PURE__ */ React__default.createElement("div", __spreadValues({
    ...
    referenceElement,
    transitionDuration: hooks.useReducedMotion() ? 0 : transitionDuration,
    transition,
    mounted: visible,
    position,
    placement,
    ...
    ref: tooltipRef,
    style: __spreadProps(__spreadValues({}, _styles.body), {
