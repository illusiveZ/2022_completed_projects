...
function Swatches(_a) {
  ...
  const classes = Swatches_styles['default']({ swatchesPerRow }, classNames, __staticSelector);
  ...
  const colors = data.map((color, index) => /* @__PURE__ */ React__default.createElement(ColorSwatch.ColorSwatch, {
    ...
    key: index,
    radius: "sm",
    onClick: () => onSelect(parsers.parseColor(color)),
    style: __spreadValues({ cursor: "pointer" }, _styles.swatch),
    "aria-label": color,
    tabIndex: focusable ? 0 : -1
  }));
  return /* @__PURE__ */ React__default.createElement("div", __spreadValues({
    className: classes.swatches,
    style: __spreadValues(__spreadValues({}, style), _styles.swatches)
  }, others), colors);
}
