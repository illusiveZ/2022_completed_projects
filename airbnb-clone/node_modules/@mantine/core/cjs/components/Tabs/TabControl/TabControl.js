...
function TabControl(_a) {
  ...
  const classes = TabControl_styles['default']({ reduceMotion, color: overrideColor || color, theme, orientation }, classNames, "tabs");
  ...
  return /* @__PURE__ */ React__default.createElement("button", __spreadProps(__spreadValues(__spreadValues({}, others), props), {
    tabIndex: active ? 0 : -1,
    className: cx__default(classes.tabControl, classes[variant], { [classes.tabActive]: active }, className),
    type: "button",
    role: "tab",
    "aria-selected": active,
    ref: hooks.useMergedRef(elementRef, tabProps.elementRef),
    style: __spreadValues(__spreadValues(__spreadValues(__spreadValues({}, style), _styles.tabControl), _styles[variant]), active ? _styles.tabActive : null)
  }), /* @__PURE__ */ React__default.createElement("div", {
    className: classes.tabInner,
    style: _styles.tabInner
  }, icon && /* @__PURE__ */ React__default.createElement("div", {
    className: classes.tabIcon,
    style: _styles.tabIcon
  }, icon), label && /* @__PURE__ */ React__default.createElement("div", {
    className: classes.tabLabel,
    style: _styles.tabLabel
  }, label)));
}
