...
var useStyles = createMemoStyles.createMemoStyles({
  tabActive: {},
  tabLabel: {},
  tabControl: ({ theme, orientation }) => __spreadProps(__spreadValues(__spreadValues({}, getFontStyles.getFontStyles(theme)), getFocusStyles.getFocusStyles(theme)), {
  ...
  default: ({ theme, reduceMotion, color, orientation }) => ({
    ...
    "&$tabActive": {
      ...
      [orientation === "horizontal" ? "borderBottomColor" : "borderRightColor"]: getThemeColor.getThemeColor({
        theme,
        color,
