...
function NumberInput(_a) {
  ...
  const classes = NumberInput_styles['default']({ theme, radius, size }, classNames, "number-input");
  ...
  const rightSection = /* @__PURE__ */ React__default.createElement("div", {
    ...
    style: __spreadValues(__spreadValues({}, _styles.control), _styles.controlUp),
    onMouseDown: (event) => {
    ...
    style: __spreadValues(__spreadValues({}, _styles.control), _styles.controlDown),
    onMouseDown: (event) => {
      event.preventDefault();
      decrement();
      inputRef.current.focus();
  ...
  return /* @__PURE__ */ React__default.createElement(TextInput.TextInput, __spreadProps(__spreadValues({}, others), {
    ...
    rightSectionWidth: getSizeValue.getSizeValue({ size, sizes: NumberInput_styles.CONTROL_SIZES }) + 1,
    radius,
    max,
    min,
    step,
