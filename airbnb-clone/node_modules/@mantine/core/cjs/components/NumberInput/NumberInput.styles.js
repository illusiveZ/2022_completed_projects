...
var useStyles = createMemoStyles.createMemoStyles({
  ...
  control: ({ theme, size }) => ({
    ...
    width: getSizeValue.getSizeValue({ size, sizes: CONTROL_SIZES }),
    padding: 0,
  ...
  controlUp: ({ theme, radius }) => ({
    borderTopRightRadius: getSizeValue.getSizeValue({ size: radius, sizes: theme.radius }) - 1,
    "&::after": {
      borderWidth: [0, 5, 5, 5],
      borderColor: [
        "transparent",
  ...
  controlDown: ({ theme, radius }) => ({
    borderBottomRightRadius: getSizeValue.getSizeValue({ size: radius, sizes: theme.radius }) - 1,
    borderBottom: 0,
    "&::after": {
      borderWidth: [5, 5, 0, 5],
      borderColor: [
