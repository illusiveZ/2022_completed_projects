...
function Divider(_a) {
  ...
  return /* @__PURE__ */ React__default.createElement("div", __spreadValues({
    ...
    style: __spreadValues(__spreadValues(__spreadValues({}, style), horizontal ? _styles.horizontal : _styles.vertical), withLabel ? _styles.withLabel : null)
    ...
    style: __spreadValues(__spreadValues({ marginTop: 2 }, _styles.label), _styles[labelPosition]),
