...
export declare function Popper<T extends HTMLElement = HTMLDivElement>({ position, placement, gutter, arrowSize, withArrow, referenceElement, children, mounted, transition, transitionDuration, transitionTimingFunction, arrowClassName, arrowStyle, zIndex, forceUpdateDependencies, }: PopperProps<T>): JSX.Element;
