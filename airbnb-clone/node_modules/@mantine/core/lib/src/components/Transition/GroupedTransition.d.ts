...
export declare function GroupedTransition({ transitions, duration, mounted, children, themeOverride, timingFunction, onExit, onEntered, onEnter, onExited, }: GroupedTransitionProps): JSX.Element;
