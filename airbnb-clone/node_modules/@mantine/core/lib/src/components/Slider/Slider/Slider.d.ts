...
export declare function Slider({ themeOverride, classNames, styles, color, value, onChange, size, radius, min, max, step, defaultValue, name, marks, label, labelTransition, labelTransitionDuration, labelTransitionTimingFunction, labelAlwaysOn, thumbLabel, ...others }: SliderProps): JSX.Element;
