...
const BUTTON_VARIANTS = ["link", "filled", "outline", "light"];
function Button(_a) {
  var _b = _a, {
    className,
    style,
  ...
  const classes = useStyles({ radius, color, size, fullWidth, theme, compact }, classNames, "button");
  ...
  return /* @__PURE__ */ React.createElement(Element, __spreadProps(__spreadValues({}, others), {
    ...
    style: __spreadValues(__spreadValues({}, _styles.icon), _styles.leftIcon)
  }, leftIcon), /* @__PURE__ */ React.createElement("span", {
    className: classes.label,
    style: __spreadValues({ textTransform: uppercase ? "uppercase" : void 0 }, _styles.label)
  }, children), rightIcon && /* @__PURE__ */ React.createElement("span", {
    className: cx(classes.icon, classes.rightIcon),
    style: __spreadValues(__spreadValues({}, _styles.icon), _styles.rightIcon)
  }, rightIcon)));
}
Button.displayName = "@mantine/core/Button";

export { BUTTON_SIZES, BUTTON_VARIANTS, Button };
