...
function MantineDrawer(_a) {
  ...
  return /* @__PURE__ */ React.createElement(GroupedTransition, {
    ...
    role: "dialog",
    "aria-modal": true,
    style: __spreadValues(__spreadValues(__spreadValues({}, style), _styles.root), noOverlay ? _styles.noOverlay : null)
  }, others), /* @__PURE__ */ React.createElement(Paper, {
    className: cx(classes.drawer, className),
    elementRef: useMergedRef(focusTrapRef, clickOutsideRef),
    style: __spreadProps(__spreadValues(__spreadValues({}, transitionStyles.drawer), _styles.drawer), { zIndex: zIndex + 1 }),
    radius: 0,
    tabIndex: -1,
