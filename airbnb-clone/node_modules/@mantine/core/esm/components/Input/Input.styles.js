...
var useStyles = createMemoStyles({
  ...
  input: ({ theme, size, multiline, radius, variant, invalid, disabled }) => {
    ...
    return __spreadValues(__spreadProps(__spreadValues(__spreadValues(__spreadProps(__spreadValues(__spreadValues({}, getFontStyles(theme)), getVariantStyles({ variant, theme })), {
