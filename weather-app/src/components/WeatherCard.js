  ...
  return (
    <>
      <div className="shadow-lg rounded-xl h-auto overflow-hidden w-full md:w-3/5 lg:w-1/2 m-auto mt-4">
        <div className="m-4">
          ...
          <div className="flex flex-row justify-between my-8 lg:my-4 text-5xl lg:text-6xl tracking-wide">
            ...
            <div className="text-8xl sm:text-9xl mt-4 text-blue-400">
      ...
      <div className="w-full md:w-3/5 lg:w-1/2 m-auto mt-4">
        <button
          type="button"
          className="text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-500 focus:ring-blue-400"
          id="user-menu"
          aria-expanded="false"
          aria-haspopup="true"
